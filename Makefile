...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(srcdir)/config.h.in $(top_srcdir)/swig/version.h.in \
	$(srcdir)/cabocha-config.in $(srcdir)/cabocharc.in \
	$(srcdir)/cabocha.iss.in COPYING TODO compile config.guess \
...
CONFIG_CLEAN_FILES = swig/version.h cabocha-config cabocharc \
	cabocha.iss
...
ACLOCAL = ${SHELL} /Users/mosa/Downloads/cabocha-0.69/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /Users/mosa/Downloads/cabocha-0.69/missing autoconf
AUTOHEADER = ${SHELL} /Users/mosa/Downloads/cabocha-0.69/missing autoheader
AUTOMAKE = ${SHELL} /Users/mosa/Downloads/cabocha-0.69/missing automake-1.14
AWK = awk
CABOCHA_DEFAULT_RC = ${prefix}/etc/cabocharc
CABOCHA_LIBS = -lcrfpp -lmecab  -L/usr/local/lib -lmecab -lstdc++ -liconv
...
LTVERSION = 5:0:0
MAINT = #
MAKEINFO = ${SHELL} /Users/mosa/Downloads/cabocha-0.69/missing makeinfo
MANIFEST_TOOL = :
MECAB_CFLAGS = 
...
STRIP = strip
VERSION = 0.69
abs_builddir = /Users/mosa/Downloads/cabocha-0.69
abs_srcdir = /Users/mosa/Downloads/cabocha-0.69
abs_top_builddir = /Users/mosa/Downloads/cabocha-0.69
abs_top_srcdir = /Users/mosa/Downloads/cabocha-0.69
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/mosa/Downloads/cabocha-0.69/install-sh
...
cabocha-config: $(top_builddir)/config.status $(srcdir)/cabocha-config.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
cabocharc: $(top_builddir)/config.status $(srcdir)/cabocharc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
cabocha.iss: $(top_builddir)/config.status $(srcdir)/cabocha.iss.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
export-package:
	python googlecode_upload.py -p cabocha -s cabocha      -u taku.ku@gmail.com -w `cat ~/.googlecode_upload_password` cabocha-0.69.tar.bz2
	python googlecode_upload.py -p cabocha -s cabocha-win  -u taku.ku@gmail.com -w `cat ~/.googlecode_upload_password` cabocha-0.69.exe
